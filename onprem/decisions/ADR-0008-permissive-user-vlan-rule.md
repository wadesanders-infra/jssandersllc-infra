...
- The USER VLAN's isolation from the business segments (it exists specifically to keep the personal/lab machine off the business network) limits the blast radius of the permissive rule in the meantime: it is broad outbound from one isolated segment, not broad access into the business VLANs.
